...
// Helper to turn decimal hours (e.g., 12.5) into a "12:30" string
...
void PrayerCalculator::calculatePrayerTimes(int dayOfYear) {
    ...
    formatTimeStr(0, baseNoon - 4.5 - (dayLengthFactor * 0.5)); // Fajr
    formatTimeStr(1, baseNoon);                                 // Dhuhr
    formatTimeStr(2, baseNoon + 5.5 + (dayLengthFactor * 0.2)); // Asr
